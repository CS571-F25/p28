...
return (
       ...
       <div style={{ width: "100%", maxWidth: 1400, display: "grid", gap: "1.5rem" }}>
               <Row className="g-4">
                   ...
                   <Col md={6} as="section" className="rounded p-4 mb-4" style={{ background: "#6ca6cbff" }}>
                   ...
                   {/* Top-right: Pages */}
                   <Col md={6} as="section" className="rounded p-4 mb-4" style={{ background: "#569245ff" }}>
                       <h2 className="mt-0">Pages</h2>
               ...
               <Row className="g-4">
                   ...
                   <Col md={6} as="section" className="rounded p-4" style={{ background: "#e19c56ff" }}>
                       <h2 className="mt-0">Our Team</h2>
                   ...
                   <Col md={6} as="section" className="rounded p-4" style={{ background: "#8958a1ff" }}>
